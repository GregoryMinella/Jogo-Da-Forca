...
namespace jogo_da_forca
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Diga uma Palavra:";
			// 
			// listBox1
			// 
			...
			this.textBox2.Location = new System.Drawing.Point(346, 87);
			...
			this.button2.Text = "Chute uma Letra";
			...
			this.button3.Text = "Chute a Palavra";
			...
			this.textBox3.Location = new System.Drawing.Point(346, 162);
